...
Studio maintains a separate **draft layer** using [unstorage](https://unstorage.unjs.io/), backed by IndexedDB.
...
When you publish, Studio commits your draft changes directly to your Git repository (GitHub or GitLab) through the provider's API.
