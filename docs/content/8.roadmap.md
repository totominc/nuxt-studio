...
::note
This roadmap is subject to change based on community feedback and evolving priorities. Join the conversation on [GitHub Discussions](https://github.com/nuxt-content/nuxt-studio/discussions) or [join the Discord](https://discord.gg/sBXDm6e8SP) to help shape the future of Nuxt Studio.
::
...
Multi-language support for the Studio interface (25 languages: AR, BG, BN, CS, DE, EN, ES, FA, FI, FR, ID, IT, JA, KO, NB-NO, NL, NN-NO, PL, PT-BR, RU, TH, UA, ZH, ZH-TW).
